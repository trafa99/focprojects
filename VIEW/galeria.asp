    ...
    <nav class="navbar navbar-expand-md fixed-top NavbarColor droidSansFont">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav nav-fill">
                <li class="nav-item">
                    <a class="nav-link" href="https://www.oswaldocruz.br/visite/VIEW/default.asp">Visite</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="https://www.oswaldocruz.br/visite/VIEW/conheca.asp">Desde 1914</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="https://www.oswaldocruz.br/visite/VIEW/galeria.asp">Galeria</a>
                </li>
                <li class="nav-item">
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="../RESOURCES/IMGS/galeria/1.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/2.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/3.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/4.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/5.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/6.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/7.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/8.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/9.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/10.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/11.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/12.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/13.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/14.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/15.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/16.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/17.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/18.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/19.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/20.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/21.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/22.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/23.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/24.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/25.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../RESOURCES/IMGS/galeria/26.jpg" class="d-block w-100" alt="...">
                            </div>
                        </div>
